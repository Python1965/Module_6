...
class Vehicle:
    ...
    def get_model(self): # return self- возвращает строку: "Модель: <название модели транспорта>"
    ...
    def set_color(self, new_color):  # принимает аргумент new_color(str), меняет цвет __color на new_color,
        ...
        for item in self.__COLOR_VARIANTS:
            if item.upper() == new_color.upper():
